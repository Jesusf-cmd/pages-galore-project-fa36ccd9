...
export default function DrivewaysOklahomaCity() {
  return (
    <ServicePage
      ...
      sections={[
        {
          ...
          content: [
            ...
            "Whether you need a new driveway or a full replacement, our team also provides <a href='/foundations-oklahoma-city'>concrete foundation services in Oklahoma City</a> and <a href='/patios-oklahoma-city'>concrete patio and slab installation in Oklahoma City</a> with the same attention to quality and durability.",
          ],
        },
        {
          eyebrow: "Our Process",
      ...
      faq={[
        { question: "How much does a concrete driveway cost in Oklahoma City?", answer: "Most concrete driveways in OKC run $6–$10 per sq ft installed. A standard 24×25 ft driveway (600 sq ft) costs $3,600–$6,000 depending on thickness, reinforcement, and whether demolition of an existing driveway is required. Stamped or decorative finishes run $10–$14/sq ft. We provide free written estimates with exact measurements before any work starts." },
        { question: "How long does a concrete driveway last in Oklahoma?", answer: "A properly installed concrete driveway in Oklahoma typically lasts 30–50 years. The key factors are base preparation (minimum 4-inch compacted aggregate), rebar reinforcement, control joint placement, and proper drainage grading. Driveways built without these steps on Oklahoma's expansive clay soil often crack within 3–5 years." },
