...
const blogPosts: Record<string, { title: string; date: string; time: string; tags: string[]; deck: string; sections: { heading: string; content: string[] }[] }> = {
  "why-concrete-driveways-crack-oklahoma": {
    ...
    sections: [
      ...
      { heading: "Cause #5: Drainage Problems", content: ["Water accelerates everything that makes Oklahoma clay problematic. A driveway graded flat or toward the house keeps soil saturated, increasing swell-shrink cycles. Every <a href='/patios-oklahoma-city' class='text-orange no-underline'>concrete patio</a> and <a href='/foundations-oklahoma-city' class='text-orange no-underline'>foundation</a> we pour in OKC is graded for drainage."] },
    ],
  },
  ...
  "rebar-vs-wire-mesh-concrete-slabs": {
    ...
    sections: [
      ...
      { heading: "Oklahoma Clay Soil: Why the Choice Matters More Here", content: ["In a state with stable soil, wire mesh might be adequate for a patio. In Oklahoma, where clay swells and contracts dramatically, rebar is the right call for any <a href='/patios-oklahoma-city' class='text-orange no-underline'>concrete slab in OKC</a> that needs to last. This applies equally to <a href='/driveways-oklahoma-city' class='text-orange no-underline'>concrete driveways</a>, <a href='/foundations-oklahoma-city' class='text-orange no-underline'>foundations</a>, and <a href='/patios-oklahoma-city' class='text-orange no-underline'>patio slabs</a> across the Oklahoma City metro."] },
  ...
  "how-thick-should-driveway-be-oklahoma": {
    ...
    sections: [
      { heading: "The Standard: 4 Inches for Passenger Vehicles", content: ["4 inches of <a href='/driveways-oklahoma-city' class='text-orange no-underline'>concrete driveway</a> on a properly prepared base is adequate for standard passenger vehicles — cars, minivans, and light SUVs."] },
      ...
      { heading: "The Base Matters as Much as the Thickness", content: ["A 6-inch slab on uncompacted soil will fail faster than a 4-inch slab on properly prepared aggregate base. Base prep is the single most important factor. Our <a href='/patios-oklahoma-city' class='text-orange no-underline'>concrete slab contractors in OKC</a> always begin with a thorough base prep assessment — it matters more than the slab thickness."] },
    ],
  },
  "best-time-of-year-to-pour-concrete-okc": {
    ...
    sections: [
      { heading: "The Ideal Window: October Through April", content: ["Fall and spring offer the best temperatures for new <a href='/driveways-oklahoma-city' class='text-orange no-underline'>driveway installation</a> in Oklahoma City, <a href='/patios-oklahoma-city' class='text-orange no-underline'>patio concrete pours</a>, and <a href='/foundations-oklahoma-city' class='text-orange no-underline'>foundation pours</a> — moderate heat, manageable humidity, and minimal freeze risk."] },
