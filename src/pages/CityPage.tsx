...
const SVC = {
  ...
  parking: { label: "Concrete parking lots", to: "/parking-lots-oklahoma-city", blurb: "New construction, replacement, and ADA-compliant commercial parking lots." },
...
/** Local service×city pages — prefer these over metro URLs when a city has a dedicated page. */
const LOCAL = {
  drivewaysEdmond: { label: "Concrete driveways in Edmond", to: "/driveways-edmond", blurb: "Tear-out, replacement, and new driveways built for Edmond's sandy-to-clay soil mix." },
  patiosEdmond: { label: "Patios & slabs in Edmond", to: "/patios-edmond", blurb: "Patios, garage slabs, and stamped finishes for Edmond homes and builders." },
  foundationsEdmond: { label: "Foundations in Edmond", to: "/foundations-edmond", blurb: "Slab-on-grade, stem walls, and footings engineered for Edmond lots." },
  retainingEdmond: { label: "Retaining walls in Edmond", to: "/retaining-walls-edmond", blurb: "Structural and landscape walls with drainage detailed for Edmond's rolling grade." },
  drivewaysNorman: { label: "Concrete driveways in Norman", to: "/driveways-norman", blurb: "Driveway installation and replacement for Norman and Cleveland County." },
  patiosNorman: { label: "Patios & slabs in Norman", to: "/patios-norman", blurb: "Patios, garage floors, and stamped concrete across Norman." },
  foundationsNorman: { label: "Foundations in Norman", to: "/foundations-norman", blurb: "Residential and commercial foundations for Norman clay and river-influenced soils." },
  retainingNorman: { label: "Retaining walls in Norman", to: "/retaining-walls-norman", blurb: "Poured and block retaining walls for Norman slopes and grade changes." },
  drivewaysYukon: { label: "Concrete driveways in Yukon", to: "/driveways-yukon", blurb: "New pours and replacements for Yukon subdivisions and established neighborhoods." },
  patiosYukon: { label: "Patios & slabs in Yukon", to: "/patios-yukon", blurb: "Patio slabs and stamped concrete for Yukon homeowners." },
  foundationsYukon: { label: "Foundations in Yukon", to: "/foundations-yukon", blurb: "Foundations and pads for Yukon new construction and replacements." },
  drivewaysMoore: { label: "Concrete driveways in Moore", to: "/driveways-moore", blurb: "Driveways graded for Moore's flat clay lots and drainage needs." },
  patiosMoore: { label: "Patios & slabs in Moore", to: "/patios-moore", blurb: "Patio and garage slabs built for Moore soil and slope conditions." },
  drivewaysMustang: { label: "Concrete driveways in Mustang", to: "/driveways-mustang", blurb: "Driveway installation and replacement for Mustang homeowners and builders." },
};
