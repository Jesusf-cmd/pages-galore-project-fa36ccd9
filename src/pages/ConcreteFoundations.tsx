...
export default function ConcreteFoundations() {
  return (
    <ServicePage
      metaTitle="Concrete Foundation Contractor in Oklahoma City | FDZ Construction LLC"
      metaDescription="Concrete foundation contractor in Oklahoma City for residential and commercial projects. Call FDZ Construction LLC for reliable foundation work and free estimates."
      eyebrow="OKC Metro · Foundation Contractors · Licensed & Insured"
      title="Concrete Foundation Contractor in"
      titleAccent="Oklahoma City."
      description='FDZ Construction LLC provides concrete foundation services in Oklahoma City for residential and commercial projects. We install foundations with a focus on proper preparation, dependable workmanship, and long-term structural performance.'
      sections={[
        {
        ...
        },
        {
          ...
          content: [
            "Foundation work has to be done right the first time. FDZ Construction LLC focuses on dependable scheduling, clear communication, and solid concrete workmanship. We understand the importance of structural support, proper forming, and a foundation that meets the needs of the project.",
