...
export default function ConcretePatioOKC() {
  return (
    <ServicePage
      metaTitle="Concrete Patio Contractors in Oklahoma City | FDZ Construction LLC"
      ...
      description='Smooth, broom, and stamped finishes — properly graded and reinforced for Oklahoma weather. Free estimate. <a href="tel:4054584805">(405) 458-4805</a>.'
      sections={[
        {
          ...
          content: [
            "<strong>Concrete patio contractors in OKC</strong> at FDZ Construction build patios that handle Oklahoma's temperature swings — from freezing winters to 105°F summers. Proper grading, reinforcement, and control joints keep your patio looking new for decades.",
        ...
        },
        {
          ...
          content: [
            "FDZ Construction LLC has built hundreds of concrete patios across Oklahoma City, <a href='/edmond-concrete'>Edmond</a>, <a href='/norman-ok-concrete'>Norman</a>, and the surrounding metro. Our 4.9-star Google rating reflects our commitment to quality work and honest pricing.",
