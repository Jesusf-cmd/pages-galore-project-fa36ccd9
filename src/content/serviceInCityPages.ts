...
/** Shared city×service copy used by React pages and prerender HTML. */

export type ServiceInCityData = {
  // routing + SEO
  path: string;
  metaTitle: string;
...
export const serviceInCityPages: Record<string, ServiceInCityData> = {
  "driveways-edmond": {
...
export const SERVICE_CITY_SLUGS = Object.keys(serviceInCityPages);
