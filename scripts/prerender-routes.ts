...
export const routes: PrerenderRoute[] = [
  ...
  },
  {
    ...
    title: "Concrete Patios, Slabs & Stamped Concrete Oklahoma City | Redwood Construction LLC",
    ...
    content: "Patios, garage floors, shop slabs, and stamped decorative concrete for Oklahoma City homeowners — properly graded, reinforced for OKC clay soil. We offer broom finish, smooth finish, and stamped decorative options including ashlar slate, random flagstone, herringbone brick, and wood plank patterns. Professional concrete patio and slab contractors serving the OKC metro area. Call (405) 247-0027 for a free estimate.",
  },
  {
    path: "/foundations-oklahoma-city",
    title: "Concrete Foundations & Retaining Walls Oklahoma City | Redwood Construction LLC",
    description: "Concrete foundation and retaining wall contractor in Oklahoma City. Residential, commercial foundations, poured concrete walls, CMU block walls. Free estimate: (405) 247-0027.",
    h1: "Concrete Foundations & Retaining Walls in Oklahoma City",
    content: "Redwood Construction LLC provides concrete foundation and retaining wall services in Oklahoma City for residential and commercial projects. We install foundations with a focus on proper preparation, dependable workmanship, and long-term structural performance. Poured concrete, CMU block, and interlocking retaining walls for slopes, drainage, and erosion control. Call (405) 247-0027 for a free estimate.",
  },
  {
    path: "/sidewalks-oklahoma-city",
    title: "Concrete Sidewalks, Curb & Gutter Oklahoma City | Redwood Construction LLC",
    ...
    content: "Sidewalks, walkways, curb and gutter installation in Oklahoma City. New construction, city right-of-way replacements, ADA-compliant ramps, and city-spec curb work for residential and commercial projects. $6–$10/sq ft for sidewalks, $18–$30/linear ft for curb work. Call (405) 247-0027 for a free estimate.",
  },
  {
    path: "/commercial-concrete-oklahoma-city",
    title: "Commercial Concrete Contractors Oklahoma City | Redwood Construction LLC",
    description: "Commercial concrete contractors in Oklahoma City. Warehouse floors, parking lots, retail pads, industrial slabs, curb & gutter. 4,000+ PSI. Free estimate: (405) 247-0027.",
    h1: "Commercial Concrete Oklahoma City",
    content: "Commercial concrete contractors in Oklahoma City — warehouse floors, parking lots, retail pads, industrial slabs, and site work across the OKC metro. Heavy-duty commercial slabs engineered for heavy loads and high traffic. 4,000+ PSI concrete. ADA-compliant parking lots. Call (405) 247-0027 for a free estimate.",
  },
  {
