...
Serving Oklahoma City, Edmond, Norman, Moore, Yukon, Mustang, Midwest City, and Del City. Based at 7004 S Indiana Ave in south OKC. Call (405) 458-4805 or email jesus@fdzconstruction.com for a free on-site estimate.`,
  ...
  {
    path: "/dock-leveler-pits-oklahoma-city",
    title: "Dock Leveler Pit Construction Oklahoma City | FDZ Construction LLC",
    description: "Dock leveler pit construction and repair in Oklahoma City. Exact dimensions, curb angles, anchor embedments coordinated with equipment suppliers. Call (405) 458-4805.",
    h1: "Dock Leveler Pit Construction in Oklahoma City, OK",
    content: "FDZ Construction LLC builds and repairs dock leveler pits for loading docks across Oklahoma City. A dock leveler pit is the concrete cavity in a loading dock floor that houses the dock leveler mechanism — pit dimensions, steel curb angle placement, anchor bolt embedments, and utility conduit locations must be exact. FDZ coordinates directly with equipment suppliers and gets pit specs before any concrete is poured. Services: new pit construction, retrofit into existing dock, pit repair and curb angle replacement, pit enlargement for equipment upgrade. New pit construction $3,000–$10,000. Call (405) 458-4805.",
  },
  {
    path: "/truck-courts-oklahoma-city",
    title: "Truck Court Construction Oklahoma City | FDZ Construction LLC",
    ...
    h1: "Truck Court Construction in Oklahoma City, OK",
    content: "FDZ Construction LLC builds concrete truck courts for warehouses and distribution centers across Oklahoma City. Truck courts are among the highest-stress concrete applications — daily Class 8 semi-truck loads (80,000 lbs GVW), constant turning movements, and repeated dock impact. Specs: 8\"–10\" slab thickness, 4,000–5,000 PSI minimum, continuous rebar on 12\"–18\" centers, minimum 120-foot depth for 53-foot trailer maneuvering, engineered joint spacing. Oklahoma's expansive clay requires over-excavation and proper aggregate sub-base. Truck court concrete $7–$12 per square foot. Call (405) 458-4805 for a free estimate.",
  },
  {
  ...
  {
    path: "/warehouse-floor-replacement-oklahoma-city",
    title: "Warehouse Floor Replacement Oklahoma City | FDZ Construction LLC",
    description: "Warehouse floor replacement in Oklahoma City. Phased pours, flatness tolerances for forklifts, 8\"+ reinforced concrete. Licensed commercial contractor. Call (405) 458-4805.",
    h1: "Warehouse Floor Replacement in Oklahoma City, OK",
    content: "FDZ Construction LLC handles full warehouse floor replacement across Oklahoma City — phased section-by-section replacement that keeps occupied facilities operational, laser screed flatwork to FF/FL numbers required for forklift operations, and sub-base investigation and correction before every pour. Old warehouse floors in OKC often failed on inadequate base over expansive clay — replacement that matches the original base spec will fail again. Services: full floor replacement, phased section replacement, sub-base remediation, laser screed flatwork to specification. Floor replacement $8–$16 per square foot. Call (405) 458-4805.",
  },
  {
    path: "/equipment-foundations-oklahoma-city",
    title: "Equipment Foundations Oklahoma City | FDZ Construction LLC",
    description: "Concrete equipment foundations in Oklahoma City — machine pads, generator pads, HVAC slabs, industrial equipment bases. Engineered to spec. Call (405) 458-4805.",
    h1: "Concrete Equipment Foundations in Oklahoma City, OK",
    content: "FDZ Construction LLC pours concrete equipment foundations across Oklahoma City — machine pads, generator pads, HVAC equipment pads, transformer pads, compressor and pump bases. Equipment foundations must be poured to the load specs and tolerances required by the equipment manufacturer. Anchor bolt placement from shop drawings, pour to specified PSI and thickness, cure to required strength before equipment set. Oklahoma's expansive clay requires deeper sub-base and wider footprint than stable-soil markets. Generator pads $800–$8,000, machine pads $1,500–$25,000+, HVAC pads $600–$3,000. Call (405) 458-4805.",
  },
  {
  ...
  {
    path: "/ada-ramps-oklahoma-city",
    title: "ADA Ramps & Accessibility Concrete Oklahoma City | FDZ Construction LLC",
    ...
    h1: "ADA Ramps & Accessibility Concrete in Oklahoma City",
    content: "FDZ Construction LLC installs ADA-compliant concrete ramps, curb cuts, accessible parking, detectable warning surfaces, and accessible pedestrian routes for commercial and institutional properties across Oklahoma City. All work built to current ADA Standards for Accessible Design and IBC requirements. Services: curb ramp installation, accessible parking stall construction, detectable warning surface installation, accessible route flatwork, ramp repair and replacement. Curb ramp $800–$2,500, accessible parking stall $1,200–$3,500, detectable warning panel $150–$400. Call (405) 458-4805 for a free estimate.",
  },
  {
    path: "/dumpster-pads-oklahoma-city",
    title: "Dumpster Pad Construction Oklahoma City | FDZ Construction LLC",
    description: "Concrete dumpster pad construction in Oklahoma City — reinforced, sloped, with containment curb. Commercial, industrial, and multifamily. Call (405) 458-4805.",
    h1: "Concrete Dumpster Pads in Oklahoma City",
    content: "FDZ Construction LLC builds concrete dumpster enclosure pads for commercial, industrial, and multifamily properties across Oklahoma City. A proper dumpster pad handles repeated heavy-truck loading, chemical exposure from waste, and hosing for cleaning — and is required by most OKC commercial zoning. Services: new dumpster pad construction, dumpster pad replacement, enclosure curb and containment, drainage slope correction. Standard single-dumpster pad $1,500–$4,000. Call (405) 458-4805 for a free estimate.",
  },
  {
  ...
  {
    path: "/commercial-curb-gutter-oklahoma-city",
    title: "Commercial Curb & Gutter Oklahoma City | FDZ Construction LLC",
    ...
    h1: "Commercial Curb & Gutter in Oklahoma City",
    content: "FDZ Construction LLC installs and replaces commercial concrete curb and gutter for parking lots, drive approaches, traffic islands, and site perimeter work across Oklahoma City. Services: straight and radius parking lot curb, drive approach curb returns, traffic island construction, header curb, catch basin curb integration, curb replacement and repair. Commercial curb $25–$55 per linear foot installed. Call (405) 458-4805 for a free estimate.",
  },
  {
