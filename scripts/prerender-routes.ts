...
export const routes: PrerenderRoute[] = [
  ...
  },
  {
    ...
    description: "Concrete contractor in Edmond, OK — driveways, patios, slabs & foundations for Deer Creek, Coffee Creek, and all of Oklahoma County. FDZ Construction LLC. Call (405) 458-4805.",
    h1: "Concrete Contractor in Edmond, OK",
    content: "Edmond is one of the fastest-growing cities in the OKC metro. FDZ Construction has been pouring concrete for Edmond homeowners and builders. Concrete services in Edmond include residential driveways, patio and garage slabs, stamped decorative concrete, new construction foundations, and sidewalks. Call (405) 458-4805 for a free estimate.",
  },
  {
    path: "/norman-ok-concrete",
    title: "Concrete Contractor in Norman OK | FDZ Construction LLC",
    description: "Concrete contractor in Norman, OK serving Cleveland County. Driveways, patios, slabs & retaining walls built for Norman's soil and drainage conditions. FDZ Construction LLC. (405) 458-4805.",
    h1: "Concrete Contractor in Norman, OK",
    content: "Norman, home to the University of Oklahoma, presents unique concrete challenges due to its location in Cleveland County. Concrete services in Norman include driveway installation and replacement, patio and garage slabs, stamped decorative concrete, residential foundations, and retaining walls. Call (405) 458-4805 for a free estimate.",
  },
  {
    path: "/yukon-oklahoma-concrete",
    title: "Concrete Contractor in Yukon OK | FDZ Construction LLC",
    description: "Concrete contractor in Yukon, OK — driveways, slabs, patios & commercial concrete in Canadian County. Transitional clay soil experts. FDZ Construction LLC. (405) 458-4805.",
    h1: "Concrete Contractor in Yukon, OK",
    content: "Yukon sits in Canadian County on the western edge of the OKC metro. FDZ Construction serves Yukon homeowners and businesses with driveways, patios, commercial slabs, and foundation work. Call (405) 458-4805 for a free estimate.",
  },
  {
    path: "/mustang-oklahoma-concrete",
    title: "Concrete Contractor in Mustang OK | FDZ Construction LLC",
    description: "Concrete contractor in Mustang, OK. Driveways, patios, slabs & foundations for Mustang homeowners and new construction subdivisions. FDZ Construction LLC. Call (405) 458-4805.",
    h1: "Concrete Contractor in Mustang, OK",
    content: "Mustang has experienced significant residential growth. FDZ Construction serves Mustang homeowners with driveways, patios, foundations, and decorative concrete — bringing the same quality we deliver across the OKC metro. Call (405) 458-4805 for a free estimate.",
  },
  {
    path: "/moore-oklahoma-concrete",
    title: "Concrete Contractor in Moore OK | FDZ Construction LLC",
    description: "Concrete contractor in Moore, OK — driveways, foundations & storm damage concrete replacement in Cleveland County. FDZ Construction LLC. Free estimate: (405) 458-4805.",
    h1: "Concrete Contractor in Moore, OK",
    content: "Moore, located in Cleveland County just south of Oklahoma City, is known for its strong residential communities. Concrete services in Moore include driveway installation, patio and garage slabs, stamped concrete, residential foundations, and sidewalks. Storm damage foundation replacement available. Call (405) 458-4805 for a free estimate.",
  },
  {
    path: "/midwest-city-oklahoma-concrete",
    title: "Concrete Contractor in Midwest City OK | FDZ Construction LLC",
    description: "Concrete contractor in Midwest City, OK. Driveway replacement, patio slabs & sidewalk repair in eastern Oklahoma County. FDZ Construction LLC. Call (405) 458-4805.",
    h1: "Concrete Contractor in Midwest City, OK",
    content: "Midwest City, located adjacent to Tinker Air Force Base in eastern Oklahoma County, has a well-established residential base. Concrete services include driveway replacement, patio slabs, sidewalk repair, and foundation work. Call (405) 458-4805 for a free estimate.",
  },
  {
    path: "/del-city-oklahoma-concrete",
    title: "Concrete Contractor in Del City OK | FDZ Construction LLC",
    description: "Concrete contractor in Del City, OK. Affordable driveway replacement, patio slabs & sidewalk repair. FDZ Construction LLC. Call (405) 458-4805.",
    h1: "Concrete Contractor in Del City, OK",
    content: "Del City is a tight-knit community in eastern Oklahoma County with affordable housing and established neighborhoods. Concrete services include driveway replacement, patio slabs, sidewalk work, and foundation repair. Call (405) 458-4805 for a free estimate.",
  },
  {
    path: "/our-projects",
